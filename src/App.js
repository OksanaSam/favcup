...
function App() {
  ...
  const onClick = () => {
    ...
    const url = 'https://developers.zomato.com/api/v2.1/search?entity_id=89&entity_type=city';
    const search = async () => {
          ...
          {restaurants.map((restaurant) => {
            ...
            return (
              <li key={restaurant.restaurant.id}>
                ...
                <p>Number of reviews: {restaurant.restaurant.all_reviews_count}</p>
                <p>Average rating: {restaurant.restaurant.user_rating.aggregate_rating}</p>
